...
import org.apache.beam.runners.local.translation.batch.PipelineTranslatorBatch;
...
public final class LocalRunner extends PipelineRunner<LocalPipelineResult> {
  ...
  public LocalPipelineResult run(final Pipeline pipeline) {
    ...
    new PipelineTranslatorBatch().evaluate(pipeline, options, metrics);
    return new LocalPipelineResult(metrics);
  }
